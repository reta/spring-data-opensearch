...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      ...
      version("spring-boot", "4.1.0-M4")
      library("data-commons", "org.springframework.data:spring-data-commons:4.1.0-RC1")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:6.1.0-RC1")
      ...
      library("projectreactor", "io.projectreactor:reactor-test:3.8.4")
